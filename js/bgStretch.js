			...
			var th=$(this),
				...
				_={
					...
					init:function(){
						...
						_.me.wrap('<div></div>')
						_.wrap=_.me.parent()
						_.wrap.css({minWidth:'480px', minHeight:'960px'})
				...
				_={
					...
					preFu:function(){
						_.me.css('position')=='static'
							&&_.me.css({position:'relative',zIndex:10})
					},					
					chngFu:function(src){
						//if(src==_.src)
							//return false
									...
									_.clone
										...
										.animate({
											...
											complete:function(){
                                                ...
                                                _.me.parent().fadeIn(600)
                                                $('#description').css({display:'block'}).stop().animate({opacity:1}, aniButtonDuration)
                                                $('#close_gall').fadeIn(600);
                                                //console.log(_.src)
											}
										})
										_.buff.detach()
			...
			var th=$(this),
				...
				_={
					...
					chngFu:function(n, j){
                        ...
                        _.href = _.li.eq(n).find('a').eq(j).attr('href');
                        $('#description li').eq(n).find('> div').eq(j).css({display:'block'})
