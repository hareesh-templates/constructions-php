						...
						<div class="row row-eq-height">
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Interiors(Desgin & Build)</a></h2>
							...
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Turnkey Construction Projects</a></h2>
							...
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Architecture & Engineering</a></h2>
							...
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Project Management(PMC)</a></h2>
							...
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Smart Home</a></h2>
							...
							<div class="col-sm-6 col-md-6 col-lg-4 ">
								...
								<div class="services">
									...
									<h2 class="services__title"><a href="#">Exteriors</a></h2>
